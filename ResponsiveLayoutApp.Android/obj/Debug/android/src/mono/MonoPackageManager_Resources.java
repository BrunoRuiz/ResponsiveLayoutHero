...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "ResponsiveLayoutApp.Android.dll" comes first in this list. */
		"ResponsiveLayoutApp.Android.dll",
		"ResponsiveLayoutAppDto.dll",
		"FormsViewGroup.dll",
		"Microsoft.Bcl.AsyncInterfaces.dll",
		"Newtonsoft.Json.dll",
		"PropertyChanged.dll",
		"Refit.dll",
		"ResponsiveLayoutApp.dll",
